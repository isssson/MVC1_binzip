...
function popupPhonecheck(){
	window.open('phoneCheck.jsp','phonecheck','width=550,height=250, left=800, top=300');
}
</script>
<body>
	...
	<h4>회 원 가 입</h4>
		<table class="join_table">
			...
			<tr>
				...
				<td class="tx02"><input type="password" name="pwd" id="txsize" maxlength="16" placeholder="비밀번호 확인"></td>
			</tr>
			<tr>
				<td class="tx01">질문</td>
			...
			<tr>
				...
				<td class="tx02"><input type="text" name="answer" id="txsize" placeholder="답변을 입력해주세요"></td>
			</tr>
			<tr>
				<td class="tx01">이름</td>
				<td class="tx02"><input type="text" name="name" id="txsize" placeholder="이름을 입력해주세요"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tx02"><input type="email" name="email" id="txsize" placeholder="이메일 형식을 갖춰 기입해주세요"></td>
			</tr>
