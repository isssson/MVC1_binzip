...
.findzip_list_left, .findzip_list_right{
	width: 50%;
}
.findzip_list_left {
	float: left;
...
.findzip_list_sub h1, .findzip_list_sub h5{
	margin: 0px;
	text-align: left;
}
.findzip_list_cont {
		...
		<div>
			<form name="findZip_main" action="#">
				<div class="search01">
					...
					<img src="/myweb/img/button_reset.jpg" alt="초기화버튼" style="width:30px;float:right;" id="btn_init">
				</div>
