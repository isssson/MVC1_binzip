...
<section>
	...
	<h4>회 원 가 입</h4>
		...
		<table class="join_table">
			<tr>
				...
				<td class="tx02"><input type="text" name="userid" id="txsize" maxlength="16" placeholder="영어 소문자, 숫자 조합으로 8~16자 입력해주세요"></td>
				<td><input type="button" value="중복 확인" class="btjoin"></td>
			</tr>
			<tr>
				<td class="tx01">비밀번호</td>
				<td class="tx02"><input type="password" name="userpwd" id="txsize" maxlength="16" placeholder="특수문자(!,@,#),영어,숫자 조합으로 8~16자 입력해주세요"></td>
			</tr>
			<tr>
				<td class="tx01">비밀번호 확인</td>
				<td class="tx02"><input type="password" name="userpwd" id="txsize" maxlength="16" placeholder="내용을 입력해주세요"></td>
			</tr>
			<tr>
				<td class="tx01">질문</td>
			...
			<tr>
				...
				<td class="tx02"><input type="text" name="tel" id="txsize"  placeholder="내용을 입력해주세요"></td>
				<td><input type="button" value="중복 확인" class="btjoin"></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="tx01">주소</td>
				<td class="tx02"><input type="text" name="addr" id="txsize"  placeholder="내용을 입력해주세요"></td>
				<td><input type="button" value="주소 찾기" class="btjoin"></td>
			</tr>
		</table>
		</form>
	</article>
	...
	<div class="join_click">
		<input type="button" value="회원 가입" class="btjoin2">
	</div>
	</article>
</section>
