...
String[] reDate = request.getParameterValues("reDate");
%>
<%
...
<section>
	...
	<article>
	<form name="reserve_ok" action="reserve2.jsp">
		<input type="hidden" name="idx" value="<%= idx%>">
		<fieldset>
			<legend>게스트 정보입력</legend>
			<table>
				<tr>
				<th>체크인</th> <!-- String.join(", ", reDate) -->
					
					<td>
						<input type="text" name="reserve_startdate" value="<%=reDate[0]%>" readonly required>
					</td>
				</tr>
				<tr>
					<th>체크아웃</th>
					<td>
						<input type="text" name="reserve_enddate" value="<%=reDate[reDate.length-1]%>" readonly required>
					</td>
				</tr>
				<tr>
					<th>예약 인원</th>
